...
async def getRequestClient(url: str, param: dict = None, headers: dict = None, httpBasic: ClientHttpBasicAuth = None) -> ClientResponseModel:
    """ 
    AioHttp Request to client wiht GET method 
    param : 
    url       = complete url for your client request 
    param     = parameter as a dict, this dict param will convert to url param 
    headers   = header parameter on your client request
    httpBasic = basic authentication on your client  
    """
